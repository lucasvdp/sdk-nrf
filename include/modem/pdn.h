 ...
 * @file pdn.h
 *
 * @brief Public APIs for the Packet Domain Network library.
 */
 ...
 * @return int Zero on success or an errno otherwise.
 */
int pdn_cid_configure(uint8_t cid, const char *apn, enum pdn_fam family,
